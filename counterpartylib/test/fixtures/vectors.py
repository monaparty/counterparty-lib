...
UNITTEST_VECTOR = {
    ...
    'api': {
        'get_rows': [{
            ...
            'out': [{'tx_index': 497, 'tx_hash': '478048dcdaca3e8010fc50a75511f6ed8fc1a770a4fab5c339a1c15c3633971f', 'block_index': 310496, 'source': 'mnfAHmddVibnZNSkh8DvKaQoiEfNsxjXzH', 'destination': 'mqPCfvqTfYctXMUfmniXeG2nyaN8w6tPmj', 'asset': config.XCP, 'quantity': 92945878046, 'status': 'valid', 'memo': None, 'memo_hex': None}]
        }, {
            'comment': 'with memo',
            'in': ('sends', [{'field':'block_index','op':'=','value':'310481'}], 'AND', None, None, None, None, None, 1000, 0, True),
            'out': [{'tx_index': 482, 'tx_hash': 'c8f63a8cd3a95ed695054f9604695203ff173b66d31986df466f9c81107a393e', 'block_index': 310481, 'source': 'mn6q3dS2EnDUx3bmyWc6D4szJNVGtaR7zc', 'destination': 'mtQheFaSfWELRB2MyMBaiWjdDm6ux9Ezns', 'asset': config.XCP, 'quantity': 100000000, 'status': 'valid', 'memo': 'hello', 'memo_hex': '68656c6c6f'}]
        }, {
            ...
            'out': [{'tx_index': 483, 'tx_hash': 'd8e60afdd3a4c9ca0f6921c759dc10e2102b28bffeacf8ad38526f1737c9707d', 'block_index': 310482, 'source': 'mtQheFaSfWELRB2MyMBaiWjdDm6ux9Ezns', 'destination': 'mn6q3dS2EnDUx3bmyWc6D4szJNVGtaR7zc', 'asset': config.XCP, 'quantity': 100000000, 'status': 'valid', 'memo': '', 'memo_hex': 'fade0001'}]
        }],
    },
    'script': {
        'validate': [{
